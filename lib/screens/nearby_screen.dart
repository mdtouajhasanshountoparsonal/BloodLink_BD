...
class _NearbyScreenState extends State<NearbyScreen> {
  ...
  bool _compatible(Donor d) {
    ...
    return BloodCompat.canDonateTo(donorGroup: d.bloodGroup, receiverGroup: group);
  }
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                Text('কাছের ডোনার', style: Theme.of(context).textTheme.headlineMedium),
                ...
                Row(
                  children: [
                    const Expanded(
                      child: Text('ডোনার', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w700)),
                    ),
                  ],
                ),
                ...
                Wrap(
                  ...
                  children: [
                    ...
                    _filterPill(
                      ...
                      label: _sort == 'কাছের' ? 'কাছে সবচেয়ে নিকট' : 'স্মার্ট ম্যাচ ⚡',
                    ),
                    _filterPill(
                      onTap: () => setState(() {
                        _filter = _filter == 'কম্প্যাটিবল' ? 'সবাই' : 'কম্প্যাটিবল';
                      }),
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, i) {
                            ...
                            return DonorCard(
                              ...
                              score: _filter == 'কম্প্যাটিবল' ? _scoreOf(d).total : null,
                              onCall: () => _call(d),
  ...
  Widget _mapCard() {
    ...
    final donors = _visible.where((d) => d.latitude != null && d.longitude != null).toList();
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: color.withValues(alpha: 0.4), blurRadius: 14, spreadRadius: 1)],
          ),
          alignment: Alignment.center,
          child: Text(group, style: TextStyle(color: color, fontSize: 11, fontWeight: FontWeight.w800)),
        ),
        const SizedBox(height: 4),
        Container(
          width: 6,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [BoxShadow(color: AppColors.info.withValues(alpha: 0.5), blurRadius: 18, spreadRadius: 2)],
          ),
        ...
        Container(
          width: 10,
          height: 10,
          decoration: BoxDecoration(color: AppColors.info.withValues(alpha: 0.7), shape: BoxShape.circle),
        ),
      ],
    );
  }
